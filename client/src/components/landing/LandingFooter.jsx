                ...
                <div style={{ maxWidth: "1152px", margin: "0 auto" }}>
                    ...
                    <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", paddingTop: "24px", borderTop: "1px solid #f1f5f9", flexWrap: "wrap", gap: "12px" }}>
                        ...
                        <div style={{ display: "flex", gap: "16px", alignItems: "center" }}>
                            {/* LinkedIn icon */}
                            <a href="https://www.linkedin.com/in/sudeep-kagi-b87657324/" target="_blank" rel="noopener noreferrer" style={{ color: "#94a3b8", transition: "color 0.2s" }}
                            ...
                            {/* GitHub icon */}
                            <a href="https://github.com/SudeepKagi/PushDoc.git" target="_blank" rel="noopener noreferrer" style={{ color: "#94a3b8", transition: "color 0.2s" }}
